...
describe('Page', () => {
  ...
  const getInputNode = (renderResults: RenderResult) =>
    renderResults.baseElement.querySelector('input') as HTMLInputElement

  const assertInputValue = async (
    expect: ExpectStatic,
  ...
  it('should initially render with loaded config value from server, if any', async ({
    expect,
  }) => {
